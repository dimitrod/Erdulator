...
let co2e = 0.02
let afforestation = 30
let waterLevel = 0
let population = 1650000000
let animalSpecies = 5000000
let temperature = 0
let ozoneLayer = 100
...
let animalSpeciesElem = document.getElementById("animalSpecies")
let temperatureElem = document.getElementById("temperature")
let ozoneLayerElem = document.getElementById("ozoneLayer")